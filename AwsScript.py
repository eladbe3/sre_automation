...
vpc.create_tags(Tags=[{"Key": "Name", "Value": "BlueVine"}])
...
openvpn_server_instances = ec2.create_instances(
        ImageId='ami-0fc970315c2d38f01',
        InstanceType='t2.micro',
        MaxCount=1,
        MinCount=1,
...
# This is require to SSH into the Linux virtual machines in AWS.
#chmod 400 APP-ec2-keypair*****************************************************************
